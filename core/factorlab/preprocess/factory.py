"""Preprocess-transform factory and plugin registration helpers."""
...
def default_transform_registry() -> dict[str, TransformFn]:
    """Built-in preprocess-transform callables."""
    return {
...
def discover_transform_registry(plugin_dirs: list[str | Path], on_error: str = "raise") -> dict[str, TransformFn]:
    """Discover transform callables from python files under configured plugin directories."""
    reg: dict[str, TransformFn] = {}
...
def load_transform_plugins(plugin_specs: list[Any], on_error: str = "raise") -> dict[str, TransformFn]:
    """Load transform plugins by module/function specifications."""
    reg: dict[str, TransformFn] = {}
...
def build_transform_registry(
    ...
    """Build transform registry from built-ins plus optional plugin discovery/loading."""
