...
class MeanVarianceOptimizerStrategy(Strategy):
    STRATEGY_FAMILY = "optimizer"
    STRATEGY_DESCRIPTION = "Mean-variance style allocator using score standardization and gross/net targets."
    STRATEGY_CONSTRAINTS = ("gross_target", "net_target", "optional_long_only", "optional_max_weight")
    STRATEGY_TAGS = ("optimizer", "portfolio", "risk")
