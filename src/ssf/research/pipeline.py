...
from ssf.config import ResearchConfig
...
from ssf.research.statistics import build_ic_decay, compute_daily_ic, newey_west_tstat, summarize_ic
from ssf.utils import get_logger

LOGGER = get_logger("ssf.research")
